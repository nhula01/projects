...
integer, parameter :: n_random=500 !generate random number every n_random steps
...
open(file='Van_der_Pol_eps_random500_RK4.dat',unit=11)

call random_number(temp) !temp is a random number between 0 and 1
eps=temp !eps is Van der Pol parameter - between 0 and 1
...
open(file='VanDerPol_eps_random500_FFT.dat',unit=11)
