...
double precision, parameter :: thickness_middle=20.0345435d-9 !metal thickness
...
!--------------------------------------------------------------------------!
    ...
    detection(n)=Ex(Nz-npml-50)!detecting Ex in the middle of the grid
enddo !Nt
...
open(file='/Users/phihung/NumMethod/first/homework/hw_09/example_5-880nm-20nm_middle.dat',unit=32)
do n=2,Nt_new/2
...
open(file='/Users/phihung/NumMethod/first/homework/hw_09/detection3.dat',unit=32)
  do n=1,Nt
    if(mod(n,n_save)==0)then
...
open(file='/Users/phihung/NumMethod/first/homework/hw_09/electric_t_3.dat',unit=32)
  do i=1,Nz
      write(32,*) (Ext(i,n),n=1,nt_psi) !here time in fs
  enddo
close(unit=32)

open(file='/Users/phihung/NumMethod/first/homework/hw_09/magnetic_t_3.dat',unit=32)
  do i=1,Nz-1
